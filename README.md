...
عشان كده `qutoof-android.yml` بينشر إصداراته **كمسوّدة (draft)**: الملفات ما تظهرش في صفحة
Releases للزوّار ولا تتحمّل بروابطها، وما يشوفها إلا صاحب الريبو وهو مسجّل دخول.

لو حبيت تعمل نفس الشيء لأي workflow تاني، ضيف تحت `softprops/action-gh-release`:
